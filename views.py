...
def product(request):
    ...
    try:
        if request.POST:
            ...
            ins = "INSERT INTO `product_tb`(`cat_id`,`p_name`,`p_mrp`, `p_price`,`p_details`,`p_img1`,`p_img2`,`p_img3`,`p_descleminar`, `p_status`, `p_cdate`, `p_udate`) VALUES ('"+str(cat_id)+"','"+str(p_name)+"','"+str(p_mrp)+"','"+str(p_price)+"','"+str(p_details)+"','"+str(p_image1)+"','"+str(p_image2)+"','"+str(p_image3)+"','"+str(p_descleminar)+"','"+str(p_status)+"','"+p_date+"','"+p_date+"')"
